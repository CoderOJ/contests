...
struct node_t make_node(int value, int len)
{
  struct node_t res;
...
void modify(int u, int l, int r, int ml, int mr, int value)
{
  if (ml <= l && r <= mr)
  {
...
struct node_t query(int u, int l, int r, int ql, int qr)
{
  ...
  struct node_t rl = query(u + u, l, mid, ql, qr);
